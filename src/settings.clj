...
(keys/defkeybinds [clominal.editors.editor/multi-line-maps]
  ...
  ((Alt g) l) clominal.editors.editor/goto-line
  )
...
(keys/defkeybinds [clominal.frame/maps]
  ...
  ((Alt f) o) clominal.editors.editor/file-open
  ((Alt f) n) clominal.editors.editor/file-new
  ((Alt f) t) clominal.frame/show-tools
  )
